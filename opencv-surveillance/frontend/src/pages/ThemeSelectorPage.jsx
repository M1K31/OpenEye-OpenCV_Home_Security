...
const ThemeSelectorPage = ({ onBack }) => {
  ...
  const themeInfo = {
    ...
    [THEMES.SUPERMAN]: {
      name: 'Superman',
      icon: 'S',
      description: 'Hope and power with classic red, blue, and yellow',
      colors: ['#0076a8', '#d32029', '#f2c700'],
    },
    [THEMES.BATMAN]: {
      name: 'Batman',
      icon: '🦇',
      description: 'Dark, brooding, and mysterious',
      colors: ['#111', '#333', '#edc233'],
    },
    [THEMES.WONDER_WOMAN]: {
      name: 'Wonder Woman',
      icon: '⭐',
      description: 'Regal and vibrant with gold accents',
      colors: ['#a41b30', '#0074fa', '#f4d975'],
    },
    [THEMES.FLASH]: {
      name: 'The Flash',
      icon: '⚡',
      description: 'Dynamic and energetic with speed effects',
      colors: ['#b90000', '#f4be00', '#fff'],
    },
    [THEMES.AQUAMAN]: {
      name: 'Aquaman',
      icon: '🔱',
      description: 'Deep ocean depths with aquatic feel',
      colors: ['#005642', '#d9c27f', '#7c4c2d'],
    },
    [THEMES.CYBORG]: {
      name: 'Cyborg',
      icon: '🤖',
      description: 'Modern tech with neon highlights',
      colors: ['#1a1a1a', '#555', '#ff00ff'],
    },
    [THEMES.GREEN_LANTERN]: {
      name: 'Green Lantern',
      icon: '💚',
      description: 'Bright green power with cosmic glow',
