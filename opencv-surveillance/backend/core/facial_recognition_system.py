...
class FaceRecognitionSystem:
    ...
    def __init__(
        ...
        logger.info(
            f"Face recognition system initialized with {len(self.people)} people"
        )
    ...
    def _save_database(self):
        ...
        try:
            data = {"people": self.people, "updated_at": datetime.now()}
    ...
    def recognize_faces(
        self, frame: np.ndarray, camera_id: str = "unknown"
    ) -> List[Face]:
        """
