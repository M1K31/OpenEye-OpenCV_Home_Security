...
class VideoProcessor:
    ...
    def resize_frame(
        self, frame: np.ndarray, preserve_aspect: bool = True
    ) -> np.ndarray:
        """
    ...
    def get_codec_fourcc(self) -> int:
        ...
        codec_str = self.CODEC_FOURCC.get(
            self.settings.codec, self.CODEC_FOURCC["h264"]
        )
...
VIDEO_PRESETS = {
    "ultra_quality": VideoSettings(
        resolution="1920x1080", fps_target=30, bitrate_kbps=10000, codec="h265"
    ),
    "high_quality": VideoSettings(
        resolution="1920x1080", fps_target=20, bitrate_kbps=5000, codec="h264"
    ),
    "balanced": VideoSettings(
        resolution="1280x720", fps_target=15, bitrate_kbps=2000, codec="h264"
    ),
    "low_bandwidth": VideoSettings(
        resolution="854x480", fps_target=10, bitrate_kbps=500, codec="h264"
    ),
    "minimal_bandwidth": VideoSettings(
        resolution="640x480", fps_target=5, bitrate_kbps=500, codec="mjpeg"
    ),
}
