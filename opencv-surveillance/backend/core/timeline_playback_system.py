...
class VideoPlayer:
    ...
    def extract_clip(
        self, output_path: str, start_time: float, end_time: float
    ) -> bool:
        """
        Extract video clip
    ...
    def extract_thumbnail(
        self, output_path: str, timestamp: Optional[float] = None
    ) -> bool:
        """
...
async def list_recordings(
    ...
    recordings = playback_mgr.get_recordings(
        camera_id=camera_id, start_date=start, end_date=end
    )
