    ...
    async def send(self, notification: Notification) -> bool:
        ...
        try:
            ...
            await loop.run_in_executor(
                None, self._send_smtp, msg, notification.recipient
            )
            ...
            payload = {
                ...
                "notification": {
                    ...
                    "priority": (
                        ...
                        in [AlertPriority.HIGH, AlertPriority.CRITICAL]
                        else "normal"
                    ),
                },
                "data": notification.data,
...
class AlertManager:
                    ...
                    for rule_data in data.get("rules", []):
                        rule = AlertRule(
                            ...
                            channels=[
                                ...
                                for c in rule_data.get("channels", [])
                            ],
    ...
    def _check_rate_limit(self, rule: AlertRule) -> bool:
        ...
        self._trigger_history[rule_id] = [
            t for t in self._trigger_history[rule_id] if t > cutoff_time
        ]
