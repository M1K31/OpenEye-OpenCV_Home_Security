...
def is_testing() -> bool:
    ...
    return TESTING or ENVIRONMENT == "testing"
...
def get_config_summary() -> dict:
    ...
    Returns:
        Dictionary with configuration summary (excludes sensitive values)
    """
    return {
        ...
        "security": {
            ...
            "csrf_enabled": CSRF_PROTECTION_ENABLED,
        },
        "camera": {
            "default_fps": DEFAULT_FPS,
            "connect_timeout": CAMERA_CONNECT_TIMEOUT_SECONDS,
