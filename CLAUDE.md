...
- **Always Use**: https://developer.apple.com/design/human-interface-guidelines/ as a guide (including sub-sections getting started, foundations, patterns, components, inputs, and technologies). Though many references may not apply to the project, their ideas can be adapated. 
